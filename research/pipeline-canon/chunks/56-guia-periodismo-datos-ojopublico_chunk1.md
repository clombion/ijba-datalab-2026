<!-- chunk: 1/1 | source: 56-guia-periodismo-datos-ojopublico.md | words: 20772 -->
<!-- headings: **THE** **SWISS ARMY KNIFE OF THE** **REPORTER**; **THE** **SWISS ARMY KNIFE OF THE** **REPORTER**; promote the use of data by journalists and activists inter- "; TEN DATABASES FOR TRACKING MONEY AND OTHER LEADS; **6**; **8** -->
