<!-- chunk: 1/1 | source: 121-escola-de-dados-tutorials.md | words: 1564 -->
<!-- headings: Escola de Dados — Courses and Tutorials; Course Categories; Featured Tutorials; Additional Resources; Events; Related; Tutorial 1: Scraping and Data Journalism; Scrapers in Journalism; The Journalist-Programmer; Learning to Program; Tutorial 2: Advanced Internet Search; Structure of a Search Engine; Relevance Calculation; Query Languages; Boolean Logic; Google Search Operators; Searching with Google Images; Tutorial 3: Cleaning Data with Google Sheets; Importing the File; Removing the Bulk -->
