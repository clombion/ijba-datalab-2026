<!-- chunk: 1/1 | source: 42-data-journalism-heist.md | words: 10083 -->
<!-- headings: Data Journalism Heist; How to get in, get the data, and get the story out - and make sure nobody gets hurt; Paul Bradshaw; Table of Contents; Huh?; The scouting mission: where's the data?; Scouting a local government website; Getting in; The crowbar of data journalism: pivot tables; Who might your story be about?; *What* about that who might we want to find out?; Changing the calculation; What about the columns?; Working with columns in a pivot table - and seeing percentages of rows; Bringing the cream to the top; Advanced filters - a dry run; Create an advanced filter; Advanced filters - using wildcards; Getting (the data) out; Finding related data - search techniques of the professionals -->
