---
title: "Data Journalism’s Ties With Civic Tech"
authors: []
section: "Organising Data Journalism"
source_url: "https://datajournalism.com/read/handbook/two/organising-data-journalism/data-journalisms-entanglements-with-civic-tech"
---
...
Examples of civic tech projects are [**OpenParliament**](https://www.openingparliament.org), a parliamentary monitoring website that, among other things, makes parliamentary speeches more accessible; [**WhatDoTheyKnow**](https://www.whatdotheyknow.com), a freedom of information website that helps users to submit and find freedom of information requests; and [**FixMyStreet**](https://www.fixmystreet.com), which simplifies the reporting of problems to local authorities.[1](#footnote1)
...
In addition, support from media organizations, foundations such as the [**Knight Foundation**](https://knightfoundation.org), and grassroots initiatives such as [**Hacks/Hackers**](https://www.hackshackers.com), have created continuous exchanges and collaborations between data journalists and civic technologists.
...
**New entrepreneurial forms of journalism play a particular role in the relationship between data journalism and civic tech**, as they are more open towards expanding traditional gatekeeping with civic tech’s notion of facilitating. For example, ***[ProPublica](https://www.propublica.org)*** has developed several large, searchable databases intended not only to facilitate the engagement of ordinary citizens with their governments, but also to aid journalistic investigations by reporters in local newsrooms who do not have the resources and expertise to collect, clean and analyze data themselves.

Another non-profit newsroom from Germany, [**Correctiv**](https://correctiv.org/en/), has taken a similar approach and integrated the freedom of information website of the Open Knowledge Foundation Germany into some of its applications.

This integration enabled users to directly request further information that is automatically added back to Correctiv’s database once obtained.[2](#footnote2)

While these examples illustrate that there is a growing number of organizations that expand traditional notions of journalism by incorporating practices and values from other data cultures, t**here is also the opposite**: **Data journalists that react to the similarities in practices and aspirations with other fields of data work by embracing their professional identity** as gatekeepers and storytellers.
...
[1](#footnote1). [Openparliament.ca](https://openparliament.ca), [WhatDoTheyKnow.com](https://www.whatdotheyknow.com), [FixMyStreet.com](https://www.fixmystreet.com)

[2](#footnote2). [correctiv.org](https://correctiv.org/en/)

##### Works Cited

Baack, S. (2018). Practically engaged. The entanglements between data journalism and civic tech. *Digital Journalism*, *6*(6), 673–692. [doi.org/10.1080/21670811.2017.1375382](https://doi.org/10.1080/21670811.2017.1375382)

Usher, N. (2017). Venture-backed news start-ups and the fĳield of journalism. *Digital Journalism*, *5*(9), 1116–1133. [doi.org/10.1080/21670811.2016.1272064](https://doi.org/10.1080/21670811.2016.1272064)

Wagemans, A., Witschge, T., & Harbers, F. (2019). Impact as driving force of journalistic and social change. *Journalism*, *20*(4), 552–567. [doi.org/10.1177/1464884918770538](https://doi.org/10.1177/1464884918770538)