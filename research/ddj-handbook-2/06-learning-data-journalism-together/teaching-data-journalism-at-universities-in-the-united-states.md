---
title: "Teaching Data Journalism"
authors: ["Cheryl Phillips"]
section: "Learning Data Journalism Together"
source_url: "https://datajournalism.com/read/handbook/two/training-data-journalists/teaching-data-journalism-at-universities-in-the-united-states"
---
...
At Texas State University, Professor [Cindy Royal](https://www.masscomm.txstate.edu/people/faculty/cindy-royal.html) teaches web development.[1](#footnote1) A few thousand miles east, at the University of Florida, [Mindy McAdams](https://www.jou.ufl.edu/staff/mindy-mcadams/), the Knight Chair of Journalism Technologies and the Democratic Process, and Associate Professor [Norman Lewis](https://www.jou.ufl.edu/staff/norman-lewis/), teach a variety of classes from coding to traditional data journalism and app development. [Alberto Cairo](https://com.miami.edu/profile/alberto-cairo/), the Knight Chair of Visual Journalism at the School of Communication at the University of Miami, teaches an entire programme focused on data visualization visualization.

Go north and students at Columbia University and CUNY take classes taught by practicing data journalists from NBC and *The New York Times*, learning the basics of investigative reporting along with data analysis. At the University of Maryland, media law classes regularly go through the process of submitting public records requests for journalism projects. In Nebraska, [Matt Waite](https://journalism.unl.edu/matt-waite-1) teaches students to visualize data using Legos. At Stanford University, we teach basic data analysis, coding in Python and R and basic data visualization, more for understanding than presentation.
...
In 2014 and 2015, [Charles Berret](https://charlesberret.net/) of Columbia University and I conducted [**a survey and extensive interviews with data journalists and journalism educators**](https://charlesberret.net/2016/03/14/348/). Most of those who teach data journalism reported that beginning with a spreadsheet introduces the concept of structured data to students in a way that is easy to grasp.
...
But teaching data journalism goes beyond flipped classrooms. It means thinking about other ways to teach data journalism concepts. At [SRCCON](https://srccon.org/), a regular unconference, [Sarah Cohen](https://isearch.asu.edu/profile/3189494), the Knight Chair in Data Journalism at Arizona State University, and a [Pulitzer Prize-winning journalist](https://www.pulitzer.org/winners/sari-horwitz-scott-higham-and-sarah-cohen) most recently at *The New York Times*, advocated using other analogue activities to engage students. Cohen and Waite, a professor of practice at the University of Nebraska, were introducing the idea of a common curriculum with modules that can be used by educators everywhere. The goal is to create a system where professors don’t have to build everything from scratch. At the conference in summer 2018, they led a group of participants in contributing possible modules for the effort. “We are trying not to have religion on that stuff [tools],” Cohen told the group, instead arguing that the focus should be on the “fundamental values of journalism and the fundamental values of data analysis.”

Now, [**a GitHub repo**](https://github.com/datajtext/DataJournalismTextbook) is up and going with contributors adding to and tweaking modules for use in data journalism education.[2](#foonote2) The repo also offers links to other resources in teaching data journalism, including this handbook.
...
Or tap into the many free tutorials already out there. The **annual conferences** held by [Investigative Reporters and Editors](https://www.ire.org/training/conferences/ire-2021/) (IRE) and the [National Institute for Computer-Assisted Reporting](https://www.ire.org/training/conferences/nicar-2021/) (NICAR) **yield even more tutorials** for their members on everything from pivot tables to scraping and mapping.
...
[1.](#footnote1) Credit for this chapter is due to Charles Berret, co-author of *Teaching Data and Computational Journalism*, published with support from Columbia University and John S. and James L. Knight Foundation.

[2](#footnote2). [github.com/datajtext/DataJournalismTextbook](https://github.com/datajtext/DataJournalismTextbook)

[3](#footnote3). To learn more about the grants for launching investigative journalism centres, see Boehm, J. (2018, August 6). Arizona State University, University of Maryland get grants to launch investigative journalism centers, *AZCentral*. [amp.azcentral.com/amp/902340002](https://amp.azcentral.com/amp/902340002)