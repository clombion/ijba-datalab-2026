---
title: "Infrastructuring Collaborations Around the Panama and Paradise Papers"
authors: ["Emilia Díaz-Struck, Cécile Schilis-Gallego", "Pierre Romera"]
section: "Working with Data"
source_url: "https://datajournalism.com/read/handbook/two/working-with-data/how-icij-deals-with-huge-data-dumps-like-the-panama-and-paradise-papers"
---
...
The [**International Consortium of Investigative Journalists (ICIJ)**](https://www.icij.org) is an international network of journalists launched in 1997. Journalists who are part of ICIJ’s large collaborations have diverse backgrounds and profiles. There is a wide range of reporters with different skills, some with strong data and coding skills, others with the best sources and shoe-leather reporting skills. All are united by an interest in journalism, collaboration and data.

When ICIJ’s director Gerard Ryle received a hard drive in Australia with corporate data related to tax havens and people around the world as a result of his three-year investigation of Australia’s Firepower scandal, he couldn’t at that time imagine how it would transform the story of collaborations in journalism. He arrived at ICIJ in 2011 with **more than 260 gigabytes of data** about offshore entities, about **2.5 million files**, which ended up turning in a collaboration of more than 86 journalists from 46 countries known as **[Offshore Leaks](https://www.icij.org/investigations/offshore/how-icijs-project-team-analyzed-offshore-files/)** (published in 2013).[1](#footnote1)

After Offshore Leaks came more investigative projects with large data sets and millions of files, more ad hoc developed technologies to explore them, and more networks of journalists to report on them. For instance, we recently shared with partners a new trove of 1.2 million leaked documents from the same law firm at the heart of the [**Panama Papers**](https://www.icij.org/investigations/panama-papers/) investigation, Mossack Fonseca.[2](#footnote2) This was on top of the 11.5 million Panama Papers files brought to us in 2015 by the German newspaper *Süddeutsche Zeitung* and 13.6 million documents that were the basis of the subsequent [**Paradise Papers probe**](https://www.icij.org/investigations/paradise-papers/).[3](#footnote3)
...
The ICIJ’s model is to investigate the global tax system with a [**worldwide network of journalists**](https://www.icij.org/journalists/). We rally leading reporters on five continents to improve research efforts and connect the data dots from one country to another.[4](#footnote4)
...
In order to promote collaboration, ICIJ provides a communication platform called the [**Global I-Hub**](https://www.icij.org/inside-icij/2014/07/icij-build-global-i-hub-new-secure-collaboration-tool/), building on open-source software components.[5](#footnote5) It has been described by its users as a **“private Facebook”** and allows the same kind of direct sharing of information that occurs in a physical newsroom.
...
It is mandatory when joining an ICIJ investigation to **setup a PGP key pair to encrypt emails**. The principle of [**PGP**](https://www.gnupg.org) is simple.[6](#footnote6) You own two keys: One is public and is communicated to any potential correspondent who can use it to send you encrypted emails. The second key is private and should never leave your computer. The private key serves only one purpose: To decrypt emails encrypted with your public key.
...
[1](#footnote1). [www.icij.org/investiga...](https://www.icij.org/investigations/offshore/how-icijs-project-team-analyzed-offshore-files/) [2](#footnote2). [www.icij.org/investiga...](https://www.icij.org/investigations/panama-papers/) [3](#footnote3). [www.icij.org/investiga...](https://www.icij.org/investigations/paradise-papers/) [4](#footnote4). [www.icij.org/journalist...](http://www.icij.org/journalists) [5](#footnote5). See <https://www.icij.org/blog/2014/07/icij-build-global-i-hub-new-secure-collaboration-tool/>. For a different perspective on journalistic platforms such as the I-Hub, see Cândea’s chapter in this book. [6](#footnote6). [www.gnupg.org/](https://www.gnupg.org/) [7](#footnote7). [www.icij.org/investigations/paradise-papers/...](https://www.icij.org/investigations/paradise-papers/paradise-papers-exposes-donald-trump-russia-links-and-piggy-banks-of-the-wealthiest-1-percent/),

[www.icij.org/investigations/%20paradise...](https://www.icij.org/investigations/%20paradise-papers/appleby-offshore-magic-circle-law-firm-record-of-compliance-failures-icij),

[www.icij.org/investigations/paradise-papers/roll-roll-asiacitis-u-s-marketing-tour/](https://www.icij.org/investigations/paradise-papers/roll-roll-asiacitis-u-s-marketing-tour/)

[8](#footnote8).[https://github.com/ICIJ/extrac...](https://github.com/ICIJ/extract/) [9](#footnote9). [https://github.com/projectblac...](https://github.com/projectblacklight/blacklight),

[https://en.wikipedia.org/wiki/...](https://en.wikipedia.org/wiki/Approximate_string_matching)