---
title: "Running Surveys for Investigations"
authors: ["Crina-Gabriela Boroş"]
section: "Assembling Data"
source_url: "https://datajournalism.com/read/handbook/two/assembling-data/mapping-pollution-in-indian-cities"
---
...
For instance, **[the Thomson Reuters Foundation (TRF)](https://news.trust.org/spotlight/most-dangerous-transport-systems-for-women/?tab=stories)** undertook a project reporting on how women in the world’s largest capitals perceived sexual violence on public transport affects them.[2](#footnote2) It was a survey-driven effort to raise awareness of the issue, but also to compare and contrast (the stuff stats do).
...
For example, when*[**openDemocracy**](https://www.opendemocracy.net/en/)* wanted to i**nterview reporters across 47 European Council member states about commercial pressure inside newsrooms**, there was little chance for statistical significance.
...
The [**open text**](https://www.opendemocracy.net/en/author/crina-boros-2/) fields proved particularly useful: Respondents used them to tip us. We researched their feedback, with an eye for economic censorship patterns and types of alleged wrongdoers. This informed our subsequent reporting on press freedom.[4](#footnote4)

Although we did publish an [**overview of the findings**](https://www.opendemocracy.net/openmedia/mary-fitzgerald/welcome-to-openmedia), we never released a data breakdown for the simple reason that the selection could not be randomized and country-level sample sizes were not always reached.[5](#footnote5) But [**we built a pretty good understanding**](https://www.opendemocracy.net/en/welcome-to-openmedia/) of how free the press is according to its own staff, how media corruption happens, how it evolves and sadly, how vulnerable reporters and the truth are.[6](#footnote6)
...
If you run a statistically significant study, have the courtesy to [**release its methodology**](https://news.trust.org/spotlight/most-dangerous-transport-systems-for-women/?tab=methodology).[7](#footnote7) That affords the necessary scrutiny for your audience and experts to trust your reporting. No methodology, no trust.
...
**Footnotes** [1](#footnote1). See 130 definitions of data, information and knowledge in Zins, C. (2007). Conceptual approaches for defining data, information, and knowledge. Journal of the American Society for Information Science and Technology, 58, 479–493. [2](#footnote2). [news.trust.org/spotligh...](http://news.trust.org/spotlight/most-dangerous-transport-systems-for-women/?tab=stories) [3](#footnote3). [www.raosoft.com/samples...](http://www.raosoft.com/samplesize.html), [www.surveymonkey.com/m...](https://www.surveymonkey.com/mp/sample-size-calculator/), [www.surveysystem.com/s...](https://www.surveysystem.com/sscalc.htm) [4](#footnote4). [www.opendemocracy.net/...](https://www.opendemocracy.net/en/author/crina-boros-2/) [5](#footnote5). [www.opendemocracy.net/...](https://www.opendemocracy.net/openmedia/mary-fitzgerald/welcome-to-openmedia) [6](#footnote6). [www.opendemocracy.net/...](https://www.opendemocracy.net/en/welcome-to-openmedia/) [7](#footnote7). [news.trust.org/spotligh...](http://news.trust.org/spotlight/most-dangerous-transport-systems-for-women/?tab=methodology)