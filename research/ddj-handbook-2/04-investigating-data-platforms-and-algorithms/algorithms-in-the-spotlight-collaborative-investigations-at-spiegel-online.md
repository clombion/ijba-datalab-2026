---
title: "Algorithms in the Spotlight: Collaborative Investigations at Spiegel Online"
authors: []
section: "Investigating Data, Platforms and Algorithms"
source_url: "https://datajournalism.com/read/handbook/two/investigating-data-platforms-and-algorithms/algorithms-in-the-spotlight-collaborative-investigations-at-spiegel-online"
---

The demand for transparency around algorithms is not new in Germany. In 2012, *[Der Spiegel](https://www.spiegel.de/consent-a-?targetUrl=https%3A%2F%2Fwww.spiegel.de%2F&ref=https%3A%2F%2Fwww.google.com)* columnist [Sascha Lobo](https://twitter.com/saschalobo) **[called for the mechanics of the Google search algorithm to be disclosed](www.spiegel.de/netzwelt/netzpolitik/google-suchvorschlaege-%20was-bettina-wulff-mit-mettigeln-verbindet-a-855097.html)** (Lobo, 2012), even if this would harm the company.

The reason was that Google can shape how we view the world, for example through the autocomplete function, as a prominent case in Germany illustrated. In this case, the wife of the former federal president had taken legal action against Google because problematic terms were suggested in the autocomplete function when her name was searched for. Two years later, the German minister of justice repeated this appeal, which was extended again by the federal chancellor in 2016: **Algorithms should be more transparent, Angela Merkel demanded** ([Kartell, 2014](http://www.spiegel.de/wirtschaft/unternehmen/); [Reinbold, 2016](http://www.spiegel.de/netzwelt/netzpolitik/angela-merkel-warum-die-kanzlerin-an-die-algorithmen-von-facebook-will-a-1118365.html)).
...
Our editorial team primarily relies on cooperation when it comes to the investigation of algorithms. In the run-up to the 2017 federal elections, we joined forces with the **[NGO AlgorithmWatch](http://algorithmwatch.org/de/filterblase-geplatzt-kaum-raum-fuer-personalisierung-bei-google-suchen-zur-bundestagswahl-2017/)** to gain insights into the personalization of Google search results.[1](#footnote1)
...
Almost at the same time, *Der Spiegel* collaborated with *[ProPublica](https://www.propublica.org)* to deploy their AdCollector in Germany in the months before the elections ([Angwin & Larson, 2017](http://www.propublica.org/article/help-us-monitor-political-ads-online)). The project aimed to make transparent how German parties target Facebook users with ads.

Therefore, a plug-in collected the political ads that a user sees in her stream and revealed those ads that are not displayed to her. For this project, *Der Spiegel* joined forces with other German media outlets such as *[Süddeutsche Zeitung](https://www.sueddeutsche.de)* and *[Tagesschau](https://www.tagesschau.de)*—an unusual constellation of actors who usually are in competition with each other.

In this case it was necessary to reach as many people as possible to serve the public interest. T**he results could also be published as journalistic stories, but our primary focus was transparency**. After two weeks, around 600 political advertisements had been collected and made available to the public.

*ProPublica*’s [**Julia Angwin**](https://twitter.com/JuliaAngwin) and [**Jeff Larson**](https://twitter.com/thejefflarson) introduced the idea of a collaboration at the annual conference of the German association of investigative journalists, [**Netzwerk Recherche**](https://netzwerkrecherche.org) in Hamburg, where they held a session on algorithmic accountability reporting.
...
This makes Schufa a controversial institution in Germany—and projects like **[OpenSCHUFA](http://www.openschufa.de)** absolutely vital for public debate on algorithmic accountability, in our opinion.[2](#footnote2)

The project was mainly driven by the NGOs [Open Knowledge Foundation](https://okfn.org) (OKFN) and AlgorithmWatch. *Der Spiegel* was one of two associated partners, together with [Bayerischer Rundfunk](https://www.br.de/index.html) (Bavarian Broadcasting). The idea for this project came up more or less simultaneously, with several parties involved. After some successful projects with the NGOs AlgorithmWatch and OKFN as well as with the data journalism team of Bayerischer Rundfunk, *Der Spiegel* was included in the initial discussions.
...
These results would not have been possible without the participation of many volunteers and supporters. The [crowdfunding campaign](https://www.startnext.com/openschufa) was largely successful, so that the financing of the software could be secured within the framework.[3](#footnote3)
...
Nevertheless, the topic of algorithmic accountability reporting is very important to us. This is because i**n Europe we still have the opportunity to debate the issue of algorithms in society and to shape how we want to deal with it**.
...
[1](#footnote1). [algorithmwatch.org/de/filterblase-geplatzt-kaum-raum-fuer-personalisierung-bei-google-suchen-zur-bundestagswahl-2017/](https://algorithmwatch.org/de/filterblase-geplatzt-kaum-raum-fuer-personalisierung-bei-google-suchen-zur-bundestagswahl-2017/)/ (German language)

[2](#footnote2). [www.openschufa.de](http://www.openschufa.de/) (German language)

[3](#footnote3). [www.startnext.com/open...](https://www.startnext.com/openschufa) (German language)

[4](#footnote4). The majority of these, however, came to the article via internal channels like our homepage. This was different in the case of another article, the field report featuring the author’s personal story, which was read by around 220,000 people. A fifth of them reached the article via social media channels, which is well above the average. So it seems that we were able to reach new target groups with this topic.

**Works Cited**

Angwin, J., & Larson, J. (2017, September 7). Help us monitor political ads online. *Pro- Publica*. [www.propublica.org/article/help-us-monitor-political-ads-online](https://www.propublica.org/article/help-us-monitor-political-ads-online)

Kartell, S. vor. (2014, September 16). Maas hätte gerne, dass Google geheime Such- formel offenlegt. *Der Spiegel*. [www.spiegel.de/wirtschaft/unternehmen/](https://www.spiegel.de/wirtschaft/unternehmen/)

Lobo, S. (2012, September 11). Was Bettina Wulff mit Mettigeln verbindet. *Der Spiegel*. [www.spiegel.de/netzwelt/netzpolitik/google-suchvorschlaege- was-bettina-wulff-mit-mettigeln-verbindet-a-855097.html](.%20https%3A//www.spiegel.de/netzwelt/netzpolitik/google-suchvorschlaege-%20was-bettina-wulff-mit-mettigeln-verbindet-a-855097.html)

Reinbold, F. (2016, October 26). Warum Merkel an die Algorithmen will. *Der Spiegel*. [www.spiegel.de/netzwelt/netzpolitik/angela-merkel-warum-die-kanzlerin-an-die-algorithmen-von-facebook-will-a-1118365.html](https://www.spiegel.de/netzwelt/netzpolitik/angela-merkel-warum-die-kanzlerin-an-die-algorithmen-von-facebook-will-a-1118365.html)

Seibt, P. (2018, March 9). Wie ich bei der Schufa zum “deutlich erhöhten Risiko” wurde. *Der Spiegel*. [www.spiegel.de/wirtschaft/service/schufa-wie-ich- zum-deutlich-erhoehten-risiko-wurde-a-1193506.html](https://www.spiegel.de/wirtschaft/service/schufa-wie-ich-%20zum-deutlich-erhoehten-risiko-wurde-a-1193506.html)